...
than the Elimination-Reorder variant.} This is most likely due to the list never
...
with any operation count.} Elimination-Reorder starts out the slowest, but after
5415 total operations, corresponding to at least 1354 \textsc{insert}
operations, it becomes faster than Node Copying. Eventually, Elimination-Reorder
...
\ref{fig:total-duration-per-op-vs-count.pdf}.
...
The total memory reserved by the program when using Elimination-Reorder for

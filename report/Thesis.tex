...
%==================================================================================================
\def\thesisauthor{Sune Keller}                     %Author
\def\thesistitle{Persistence in Practice}               %Title
\def\thesishandin{30-November}                       %Submission date
% (Day-Month}
\def\thesisdegree{M.Sc.}                              %Degree ('B.Eng', 'B.Sc.',
% 'M.Sc.' or 'PhD')
\def\thesisyear{2012}                               %Submission year
\def\thesisnumber{142}                             %DTU-IMM Serial number (do not include year)
...
\markboth{A}{B}                                       %Set headings (left)(right)
\input{Preface}                                     %Preface
\markboth{C}{D}                                       %Set headings (left)(right)
\input{Acknowledgements}                            %Acknowledgements
\markboth{E}{F}                                       %Set headings (left)(right)
%------------------
% Table of contents
%------------------
\newpage\mbox{}\newpage

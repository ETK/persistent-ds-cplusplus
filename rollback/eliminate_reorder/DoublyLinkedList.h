...
#ifndef ROLLBACK_REORDER_LAZY_DOUBLYLINKEDLIST_H
#define ROLLBACK_REORDER_LAZY_DOUBLYLINKEDLIST_H
...
//      virtual void rollforward();
      virtual void ensure_version (std::size_t v);
    };
  }
}
#endif                          // ROLLBACK_REORDER_LAZY_DOUBLYLINKEDLIST_H
